...
const themes = Object.keys(THEME_CSS);

for (const theme of themes) {
  // Inject theme CSS directly — bypass localStorage/React cycle entirely
  ...
  await sleep(600); // let CSS variables + repaint settle
